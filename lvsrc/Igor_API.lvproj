...
<Project Type="Project" LVVersion="19008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="API" Type="Folder">
			<Item Name="Igor_ArraytoIgorWave.vi" Type="VI" URL="../API/Igor_ArraytoIgorWave.vi"/>
			<Item Name="Igor_CloseRefnum.vi" Type="VI" URL="../API/Igor_CloseRefnum.vi"/>
			<Item Name="Igor_LoadLargeWaveUsingFile.vi" Type="VI" URL="../API/Igor_LoadLargeWaveUsingFile.vi"/>
			<Item Name="Igor_LoadWaveFromFile.vi" Type="VI" URL="../API/Igor_LoadWaveFromFile.vi"/>
			<Item Name="Igor_OpenRefnum.vi" Type="VI" URL="../API/Igor_OpenRefnum.vi"/>
			<Item Name="Igor_SaveArrayToFile.vi" Type="VI" URL="../API/Igor_SaveArrayToFile.vi"/>
			<Item Name="Igor_SaveWavesToFile.vi" Type="VI" URL="../API/Igor_SaveWavesToFile.vi"/>
			<Item Name="Igor_SendCommand.vi" Type="VI" URL="../API/Igor_SendCommand.vi"/>
		</Item>
		<Item Name="private" Type="Folder">
			<Item Name="Igor_NumericArraytoIgorWave.vi" Type="VI" URL="../private/Igor_NumericArraytoIgorWave.vi"/>
			<Item Name="Igor_StringArraytoIgorWave.vi" Type="VI" URL="../private/Igor_StringArraytoIgorWave.vi"/>
			<Item Name="DebugModeSingleton.vi" Type="VI" URL="../private/DebugModeSingleton.vi"/>
			<Item Name="Igor_EnsureIgorStringFormat.vi" Type="VI" URL="../private/Igor_EnsureIgorStringFormat.vi"/>
		</Item>
		<Item Name="Tests" Type="Folder">
			<Item Name="TestArraytoWave.vi" Type="VI" URL="../Tests/TestArraytoWave.vi"/>
			<Item Name="TestEnsureIgorStringFormat.vi" Type="VI" URL="../Tests/TestEnsureIgorStringFormat.vi"/>
		</Item>
